...
mod tests {
    ...
    use crate::utils::FrozenConstant;
    use crate::v310;
    use crate::v310::code_objects::CompareOperation::Equal;
    use crate::v310::code_objects::{AbsoluteJump, Constant, LinetableEntry};
    ...
    fn test_extended_arg() {
        ...
        let resolved = instructions.to_instructions().to_resolved(None).unwrap().0;
        match resolved
            .iter()
    ...
    fn test_absolute_jump() {
        ...
        let resolved = instructions.to_resolved(None).unwrap().0;
